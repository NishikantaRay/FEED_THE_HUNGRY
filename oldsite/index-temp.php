...
<html>
	<head>
		...
		<style type="text/css">
			...
			.feature-inner { margin:auto;padding:5px;width:970px;background:blue; }
		...
		<div id="page">
			...
			<div class="feature">
				<div class="feature-inner">
					<marquee><h1>Feed the Hungry</h1></marquee>
				</div>
			</div>
			<div id="content">
				<div id="content-inner">
					...
					<main id="contentbar">
						<div class="article">
							<p><h3>Feed the hungry is a non profitable and charitable organization working towards the welfare of poor underprivileged and hungry people of India . This is basically a small start towards a great change . FEED THE HUNGRY aims towards feeding the poor people of our locality , by providing them with food , when they are in need.<h3></p>
							<p><h2>FUTURE GROWTH :-<br></h2>
								<h3>At the beginning its just a very small step towards healthy and full INDIA.
								But there are and will be several problems regarding a solution . If we persevere and overcome the problems ,then we have plans for several amendments and new ways to help the people.
								We plan on growing to a big level first , to distribute help on a noticeable level. Then we hope to extend our services to extra and unrequired clothes to the poor and needy . 
							</h3>	</p>
								<br>
						</div>
					</main>
					<nav id="sidebar">
						<div class="widget">
							...
							<li><a href="guest-donate.php">Donate</a></li>
							<li><a href="guest-request.php">Request</a></li>
							</ul>
						</div>
					</nav>
					<div class="clr"></div>
					<marquee class="feature-inner"><h1>Toll free no-1800-12345-123</h1></marquee>
